...
import { FaMask, FaGhost, FaCertificate, FaRandom, FaUserMd, FaCrosshairs, FaMountain, FaBroom, FaGavel, FaLock, FaBriefcaseMedical, FaDice, FaSnowflake, FaBolt, FaBullhorn, FaFire, FaStar, FaExchangeAlt, FaUserSecret, FaSkullCrossbones, FaFlask, FaSkull, FaBomb, FaLightbulb, FaInfoCircle } from "react-icons/fa";
...
export default function Roles() {
  const roles = [
    ...
    },
    {
      ...
      icon: <FaCertificate className="w-6 h-6 md:w-8 md:h-8 text-yellow-400" />,
      badges: ["Crewmate", "v1.0.0"],
      video: "",
