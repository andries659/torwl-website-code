...
export function meta({ }: Route.MetaArgs) {
  return [
    { title: "TOR-W Bot - Privacy Policy" },
  ];
}
      ...
      <div className="text-center">
        ...
        <header className="flex flex-col items-center gap-9"><br />
          ...
          <p className="text-lg text-white text-justify">
            This Privacy Policy governs the collection, use, and sharing of personal information by <b>TOR-W Bot</b>, a Discord bot developed by <b>Andries (.angel_xd. on Discord)</b>. By using <b>TOR-W Bot</b>, you agree to the terms of this Privacy Policy.
          </p>
          ...
          <p className="text-lg text-white text-justify">
            We use your information to operate and improve <b>TOR-W Bot</b>, including to provide support and respond to your requests. We may also use your information to develop new features or services, to conduct research and analytics, and to comply with legal obligations.
          </p>
          ...
          <p className="text-lg text-white text-justify">
            We may update this Privacy Policy from time to time, and we will post the updated policy on our website. Your continued use of <b>TOR-W Bot</b> after we make changes to this policy indicates your acceptance of the revised policy.
          </p>
          ...
          <p className="text-lg text-white text-justify">
            This Privacy Policy is effective as of <b>11 May 2025</b>.
          </p>
          <br></br>
          <br></br>
        </header>
